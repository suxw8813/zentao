...
<?php/**feature-965**/?>
	  <tr>
        <th class='w-80px'><?php echo $lang->story->satisficingeval;?></th>
        <td class='w-p25-f'><?php echo html::select('satisficingeval', $lang->story->sevalList, '', 'class=form-control');?></td><td></td>
 	  </tr>	
<?php/**--------------**/?>	  
      <tr>
