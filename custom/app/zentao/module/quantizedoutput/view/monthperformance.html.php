         ...
         <table class='table table-condensed table-fixed table-bordered table-data' id='performanceTable'>
            <tbody>
                <tr class="a-center">
                    ...
                    <?php
                    if($orgType == 'amiba') {
                        echo $lang->quantizedoutput->amiba_name;
                    }
                    else if($orgType == 'group') {
                        echo $lang->quantizedoutput->group_name;
                    }
                    else {
                        echo $lang->quantizedoutput->realname;
                    }
                    echo '：';
                    ?>
                    </th>
                ...
                <tr class="a-center">
                    ...
                    if(!empty($outputInfo->month_wp_task)) {
                        ...
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=DevTask&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    if(!empty($outputInfo->month_wp_pr)) {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=DevBeRejectedAndLeaderCheck&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=DevBug&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ReviewPass&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ITReq&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ReqDev&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ProvinceBugReqResponse&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=InsideBugReqResponse&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ReqSatisfy&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=TestCase&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ExecuteCase&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=TestBug&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=CloseBug&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=ProvinceBugTestResponse&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=InsideBugTestResponse&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=QAOpenBug&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=QACloseBug&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
                ...
                <tr class="a-center">
                    ...
                    {
                        $monthPerformanceDetailLink = $this->createLink('quantizedoutput', 'monthperformancescoredetail', "scoreType=WorkSplit&userRootId=$userRootId&amibaName=$amibaName&isAmibaChanged=false&groupName=$groupName&account=$account&orgType=$orgType&monthNum=$monthNum");
