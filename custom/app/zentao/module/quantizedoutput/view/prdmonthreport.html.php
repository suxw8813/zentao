...
<div class='side'>
  ...
  <?php
      ...
      $monthReportExportLink = $this->createLink('quantizedoutput', 'prdmonthreportexport', "monthNum=$monthNum");
  ...
  <table class='table table-condensed table-striped table-bordered tablesorter active-disabled' id='monthreport'>
    <thead>
        <tr>
          ...
          <th width='310' colspan='4'><?php echo $lang->projectCommon;?></th>
          <th width='300' colspan='4'><?php echo $lang->quantizedoutput->person;?></th>
        </tr>
      ...
      <tr class="a-center">
        ...
        <?php 
            ...
            $timetendencyLink = $this->createLink('quantizedoutput', 'worklogs', 
                "dimType=prd&amibaId=$amiba->amiba_id&groupId=&account=&dateNum=$monthNum&timeType=月");
        ...
        <?php
            ...
            {
                $prdMonthperformanceLink = $this->createLink('quantizedoutput', 'prdMonthperformance', 
                "amibaId=$amiba->amiba_id&groupId=&account=&monthNum=$monthNum");
            
                echo "<a href='$prdMonthperformanceLink' class='iframe' data-width='80%' style='color:$fontColor'>" . $amiba->total_output . "</a>";
            }
            else
            {
                echo '-';
        ...
        <?php foreach($amiba->groups as $group):?>
            ...
            <?php 
                // 项目-实报工时
                $timetendencyLink = $this->createLink('quantizedoutput', 'worklogs', 
                    "dimType=prd&amibaId=$amiba->amiba_id&groupId=$group->group_id&account=&dateNum=$monthNum&timeType=月");
            ...
            <?php 
                ...
                if(!empty($group->total_output))
                {
                    ...
                    echo "<a href='$prdMonthperformanceLink' class='iframe' data-width='80%' style='color:$fontColor'>" . $group->total_output . "</a>";
                }
                else
                {
                    echo '-';
            ...
            <?php foreach($group->users as $user):?>
              <?php if($userindex != 1) echo "<tr class='a-center'>"?>
                ...
                <?php 
                    ...
                    {
                        $timetendencyLink = $this->createLink('quantizedoutput', 'worklogs', 
                            "dimType=prd&amibaId=$amiba->amiba_id&groupId=$group->group_id&account=$user->account&dateNum=$monthNum&timeType=月");
                ...
                <?php 
                    ...
                    if(!empty($user->total_output))
                    {
                        ...
                        echo "<a href='$prdMonthperformanceLink' class='iframe' data-width='80%' style='color:$fontColor'>" . $user->total_output . "</a>";
                    }
                    else
                    {
                        echo '-';
