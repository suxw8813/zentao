...
<div id='titlebar'>
  <div class='heading'>
    ...
    <?php 
        echo html::hidden('dimType', $dimType);
...
<style>
.task_type.story {
    background-image: url(<?php echo $defaultTheme . "images/ext/blue-label-feature-1509.png"?>);
}
.task_type.bug {
    background-image: url(<?php echo $defaultTheme . "images/ext/red-label-feature-1509.png"?>);
}
.task_type.task {
    background-image: url(<?php echo $defaultTheme . "images/ext/yellow-label-feature-1509.png"?>);
}
</style>
<div class='worklogs'>
    ...
    <table class='table table-condensed table-striped table-bordered tablesorter table-fixed active-disabled'>
      <thead>
        <tr class='text-center'>
          <th class='w-20px'><?php echo $lang->quantizedoutput->worklog->task_type_name;?></th>
          <th class='w-20px'><?php echo $lang->quantizedoutput->worklog->task_id;?></th>
          <th class='w-40px'><?php echo $lang->quantizedoutput->worklog->time_sect . '(共' . $total_time . '小时)';?></th>
          <th class='w-40px'><?php echo $lang->quantizedoutput->worklog->work_content;?></th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr class='text-center'>
          ...
          <?php if($worklog->task_type_name == $lang->quantizedoutput->zentao->story):?>
          <td><?php echo "<p>" . html::a($this->createLink('story', 'view', "taskID=$worklog->task_id"), $worklog->task_id) . "</p>";?></td>
          <?php elseif ($worklog->task_type_name == $lang->quantizedoutput->zentao->task):?>
          <td><?php echo "<p>" . html::a($this->createLink('task', 'view', "taskID=$worklog->task_id"), $worklog->task_id) . "</p>";?></td>
          <?php elseif ($worklog->task_type_name == $lang->quantizedoutput->zentao->bug):?>
