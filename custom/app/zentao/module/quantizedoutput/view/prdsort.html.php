...
<div class='main' id='sort'>
      ...
      <div class='col-sm-4'>
        <div class='input-group input-group-sm'>
          <span class='input-group-addon'><?php echo $lang->productCommon;?></span>
            <?php 
                echo html::select('amibaId', $amibaNameDict, $amibaId, "class='form-control chosen' onchange='changeParams(this)'");
            ?>
        </div>
      </div>
      <div class='col-sm-3'>
    ...
    <div class='container text-center bd-0'>
      <h1 style="margin-top: 0px;" data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('quantizedoutput', 'prdsortmore', 
            "timeType=$timeType&sortField=total_output&amibaId=$amibaId&timeNum=$timeNum");
    ...
    <div class='container text-center bd-0'>
      <h1 data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('quantizedoutput', 'prdsortmore',
            "timeType=$timeType&sortField=output_efficiency&amibaId=$amibaId&timeNum=$timeNum");
        print(html::a($worklogsLink, $lang->quantizedoutput->more, '', 'class="iframe btn btn-primary btn-sm" data-width="65%"'));
        ?>
      </h1>
    ...
    <div class='container text-center bd-0'>
      <h1 data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('quantizedoutput', 'prdsortmore', 
            "timeType=$timeType&sortField=total_time&amibaId=$amibaId&timeNum=$timeNum");
        print(html::a($worklogsLink, $lang->quantizedoutput->more, '', 'class="iframe btn btn-primary btn-sm" data-width="65%"'));
        ?>
      </h1>
