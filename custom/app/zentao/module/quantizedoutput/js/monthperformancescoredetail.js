...
function changeParams(obj)
{
    ...
    link = createLink('quantizedoutput', 'monthperformancescoredetail', 'scoreType=' + scoreType + '&userRootId=' + userRootId + '&amibaName=' + amibaName +'&isAmibaChanged=' + isAmibaChanged + '&groupName=' + groupName +'&account=' + account +'&orgType=' + orgType +'&monthNum=' + monthNum);
    location.href=link;
};