...
function changeParams(obj)
{
    ...
    link = createLink('quantizedoutput', 'sortmore', 'timeType=' + timeType + '&sortField=' + sortField + '&userRootId=' + userRootId + '&amibaname=' + amibaname + '&groupname=' + groupname + '&username=' + username + '&timeNum=' + timeNum);
    location.href=link;
}
