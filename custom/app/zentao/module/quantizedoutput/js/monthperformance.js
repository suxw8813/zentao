...
function changeParams(obj)
{
    ...
    link = createLink('quantizedoutput', 'monthperformance', 'userRootId=' + userRootId + '&amibaName=' + amibaName +'&isAmibaChanged=' + isAmibaChanged + '&groupName=' + groupName +'&account=' + account +'&orgType=' + orgType +'&monthNum=' + monthNum);
    // alert(link);
    location.href=link;
};