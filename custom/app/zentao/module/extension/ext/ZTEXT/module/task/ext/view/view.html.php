...
<div id='titlebar'>
  <div class='heading'>
	...
	<?php
        $taskperformancescoredetailLink = $this->createLink('quantizedoutput', 'taskperformancescoredetail', "taskId=$task->id");
    ?>	
...
<?php/**feature-1600**/	?>
	<?php 
		echo $task->name . "【" . "<a href='$taskperformancescoredetailLink' data-width='80%' style='color:blue;' class='iframe'>" 
			. $lang->task->quantizedoutput . "</a>"."】";
	?>
<?php/**-----------**/	?>	
	</strong>
    <?php if($task->deleted):?>
...
/*        common::printIcon('task', 'recordEstimate', "taskID=$task->id", $task, 'button', '', '', 'iframe', true);*/
		$lang->worklog->recordestimateinner = $lang->task->recordestimate;
		common::printIcon('worklog', 'recordestimate','netType=inner','','button','time');
...
<?php/**-----------------**/ ?>	  		  
	  ...
	  <fieldset>
		<legend><?php echo $lang->worklog->worklogbrowse.'('.$lang->task->totalworktime.':'.$totalworktime.')';?></legend>
...
<?php /**feature-1488**/ ?>
          <?php if($task->type == 'workloadsplit'):?>
          <tr>
            <th><?php echo $lang->task->contractsum;?></th>
            <td><?php echo $task->contractsum .' '. $lang->task->currencyunit;?></td>
          </tr>
          <?php endif;?>
<?php /**feature-1488**/ ?>		  
...
<?php /**feature-1488**/ ?>
			  <tr>
				...
				<td><?php echo  $lang->task->sevalList[$task->satisficingeval];?></td>
			  </tr>	
<?php /**-----------**/ ?> 
     ...
     <?php if($lang->task->score == '评分'):?>		
		<tr>
		  ...
		  <tr>
			...
			<td><?php echo $task->scorecomment?></td>
		  </tr>
		  <tr>
			<th></th>
			<td><?php echo $lang->task->scorenote;?></td>
		  </tr>	
	<?php endif;?>	
<?php /**--------------**/?>		  
        </table>
