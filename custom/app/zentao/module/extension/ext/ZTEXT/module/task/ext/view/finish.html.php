...
<?php/**feature-1600**/?>
      <td class='w-p25-f'><div class='input-group'><?php echo html::input('consumed', $totalworktime, "class='form-control'");?> <span class='input-group-addon'><?php echo $lang->task->hour;?></span></div></td><td></td>
    </tr>
    <tr>
...
<?php/**feature-899-wx**/?>	 
     <?php if($lang->task->finishnote <> ''):?>	
	<tr>
	  <th></th>
	  <td colspan='2' bgcolor=red><?php echo $lang->task->finishnote;?></td>
	</tr>	
	<?php endif;?>	
<?php/**-------------**/?>		
    <tr>
