...
<?php/**feature-1597**/?>	
				   <?php if($config->story->subestimate =='Y'):?>				
						<span class='input-group-addon fix-border br-0'><?php echo $lang->story->estimateStory;?></span>
						<?php echo html::input('estimatestory', $estimatestory, "class='form-control minw-60px' autocomplete='off'");?>
						<span class='input-group-addon fix-border br-0'><?php echo $lang->story->estimateTask;?></span>
						<?php echo html::input('estimatetask', $estimatetask, "class='form-control minw-60px' autocomplete='off'");?>
				   <?php else:?>
      ...
      <tr>	  
		  ...
		  <td><?php echo html::select('storytype', $lang->story->storyTypeList, $storytype, "class='form-control'");?></td>
		  <td>
			  <div class='input-group'>
				<span class='input-group-addon'><?php echo $lang->story->storyBSA?></span>
				<?php echo html::select('storybsa', $lang->story->storyBSAList, $storybsa, "class='form-control'");?>
				<span class='input-group-addon'><?php echo $lang->story->storyValueLevel?></span>
				<?php echo html::select('storyvaluelevel', $lang->story->storyValueLevelList, $storyvaluelevel, "class='form-control'");?>
			  </div>		  
		  </td>
      </tr>	 
<?php/**-------------**/?>
