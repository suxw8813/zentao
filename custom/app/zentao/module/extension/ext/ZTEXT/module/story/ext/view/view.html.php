...
?> 
	  <?php $totalworktime=0; 
			 foreach($worklogs as $worklog): 	  
				$totalworktime = $worklog->worktime + $worklog->workovertime + $totalworktime;		 
			 endforeach; 
		 ?> 	  
<?php/**-----------------**/ ?>	  	  
...
<?php/**feature-850**/ ?>
	  <fieldset>
		<legend><?php echo $lang->worklog->worklogbrowse.'('.$lang->story->totalworktime.':'.$totalworktime.')';?></legend>
...
<?php /**feature-880**/		?>	
              <tr>
                ...
                <td class='story-<?php echo $story->passnote?>'><?php echo $lang->story->passNoteList[$story->passnote];?></td>
              </tr>
<?php /*------------------------------*/		?>				  
              <tr>
...
<?php /**feature-965**/ ?>
			  <tr>
				<th><?php echo $lang->story->satisficingeval;?></th>
				<td><?php echo  $lang->story->sevalList[$story->satisficingeval];?></td>
			  </tr>	
<?php /**-----------**/ ?>  
...
<?php/**feature-1597**/?>	
			<?php if($config->story->subestimate =='Y'):?>				  
              <tr>
                ...
                <td><?php echo $story->estimatestory;?></td>
              </tr>
              <tr>
                <th><?php echo $lang->story->estimateTask;?></th>
                <td><?php echo $story->estimatetask;?></td>
              </tr>			  
		    <?php else:?>
			...
			<tr>
				...
				<td><?php echo  $lang->story->storyTypeList[$story->storytype];?></td>
			</tr>	
			<tr>
				<th><?php echo $lang->story->storyBSA;?></th>
				<td><?php echo  $lang->story->storyBSAList[$story->storybsa];?></td>
			</tr>		
			
			<tr>
				<th><?php echo $lang->story->storyValueLevel;?></th>
				<td><?php echo  $lang->story->storyValueLevelList[$story->storyvaluelevel];?></td>
			</tr>			
<?php /**-----------**/ ?>  
