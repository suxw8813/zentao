    ...
    <table class='table table-condensed table-striped table-bordered tablesorter table-fixed active-disabled'>
      <tbody>
        <tr>
            ...
            <td align='right'><?php echo $lang->quantizedoutput->commitPerson;?></td>
            <td><?php echo $users[$mergeInfo->committer];?></td>
            
        </tr>
        <tr>
            <td align='right'><?php echo $lang->quantizedoutput->belongProject;?></td>
            <td><?php echo $mergeInfo->project_name;?></td>
            
            <td align='right'><?php echo $lang->quantizedoutput->sourceBranch;?></td>
            <td><?php echo $mergeInfo->source_branch;?></td>
            
            <td align='right'><?php echo $lang->quantizedoutput->targetBranch;?></td>
            <td><?php echo $mergeInfo->target_branch;?></td>
            
        </tr>
        <tr>
            <td align='right'><?php echo $lang->quantizedoutput->prStatus;?></td>
            <td><?php echo $mergeInfo->state;?></td>
            
            <td align='right'><?php echo $lang->quantizedoutput->requestDate;?></td>
            <td><?php echo $mergeInfo->pr_time;?></td>
            
            <td align='right'><?php echo $lang->quantizedoutput->auditDate;?></td>
        ...
        <tr>
            ...
            <td>
            <?php 
            echo html::a($this->createLink('task', 'view', "taskID=$mergeInfo->task_id"),
                $mergeInfo->task_id, '', 'target="blank"');
            ?>
            </td>
        ...
        <tr>
            <td align='right'><?php echo $lang->quantizedoutput->auditPerson;?></td>
        ...
        <tr>
            ...
            <td data-container='body' data-toggle='popover' data-placement='right' data-trigger='hover' data-content='<?php 
                    echo $lang->quantizedoutput->calculateProcess . '：' . $mergeInfo->calc_process;
                    echo '<br/>';
                    echo $lang->quantizedoutput->mark . '：' . $mergeInfo->pr_desc;
                    ?>' style="overflow:hidden;text-overflow:ellipsis;">
            <?php echo $mergeInfo->calc_process;?>
            </td>
            
            <td align='right'><?php echo $lang->quantizedoutput->calculateResult;?></td>
      ...
      <table class='table table-form table-fixed table-bordered' id='mergeDetailInfoTable' style='margin-bottom:30px;'>
        <thead>
          <tr>
            ...
            <th style='text-align:center;' class='w-150px' colspan='2'><?php echo '文件大小';?></th>
        ...
        <?php
        echo html::hidden('fromUrl', $fromUrl);
        ?>
        <?php foreach($mergeInfo->mergeDetailInfo as $detail):?>
        <?php
            // 是否具有编辑权限
            $readonly = 'readonly';
            if(common::hasPriv('quantizedoutput', 'saveModMerge')){
                $readonly = '';
            }
            ...
            // 是否可修改文件个数
            $canModFileCount = strpos($config->quantizedoutput->specialFileTypes, strtolower($detail->file_type)) > 0;
        ?>
        <tr class='text-center'>
          ...
          <td>
              ...
              if($canModFileCount){
                  ...
                  echo html::input("file_count_new[$detail->id]",  zget($detail, 'file_count_new', $detail->file_count), 
                      "class='form-control' $readonly autocomplete='off' style='width:100%;float:left;color:$fontColor;' " . 
                      "onkeyup='changePerformanceFontColor(\"file_count\", $detail->id)' data-container='body' " . 
                      "data-toggle='popover' data-placement='right' data-trigger='hover' data-content='$modHistory'");
              } else {
          ...
          <td>
              ...
              if($detail->file_size != 0){
                  echo html::input("file_size[$detail->id]",  $detail->file_size, 
                  "class='form-control' readonly autocomplete='off' style='width:100%;float:left;'");
              } else {
                  echo html::hidden("file_size[$detail->id]", $detail->file_size);
              }
          ...
          <td>
              ...
              if($detail->file_size != 0){
                  // 文件大小编辑框
                  $fontColor = $detail->file_size == zget($detail, 'file_size_new', $detail->file_size)
                        ? 'black' : 'orange';
                  echo html::input("file_size_new[$detail->id]",  zget($detail, 'file_size_new', $detail->file_size), 
                      "class='form-control' $readonly autocomplete='off' style='width:100%;float:left;color:$fontColor;' " . 
                      " onkeyup='changePerformanceFontColor(\"file_size\", $detail->id)' data-container='body' " . 
                      " data-toggle='popover' data-placement='right' data-trigger='hover' data-content='$modHistory'");
              } else {
                  echo html::hidden("file_size_new[$detail->id]", zget($detail, 'file_size_new', $detail->file_size));
              }
              // <div style="margin-top:5px;float:right;">行</div>
              ?>
          </td>
          ...
          <td>
              ...
              if($detail->line_add != 0){
                  ...
                  "class='form-control' $readonly autocomplete='off' style='width:100%;float:left;color:$fontColor;' " . 
                  "onkeyup='changePerformanceFontColor(\"line_add\", $detail->id)' data-container='body' " . 
                  "data-toggle='popover' data-placement='right' data-trigger='hover' data-content='$modHistory'");
              } else {
          ...
          <td>
              ...
              if($detail->line_del != 0){
                  ...
                  "class='form-control' $readonly autocomplete='off' style='width:100%;float:left;color:$fontColor;' " . 
                  "onkeyup='changePerformanceFontColor(\"line_del\", $detail->id)' data-container='body' " . 
                  "data-toggle='popover' data-placement='right' data-trigger='hover' data-content='$modHistory'");
              } else {
          ...
          <td>
                ...
                echo html::input("remark_new[$detail->id]", $detail->remark_new,
                    "class='form-control disabled-ie-placeholder' $readonly autocomplete='off' " . 
                    "placeholder='如果该行的分数被修改，则备注为必填项...'  data-container='body' " . 
                    "data-toggle='popover' data-placement='top' data-trigger='hover' data-content='$detail->remark_new' " . 
                    "style='overflow:hidden;text-overflow:ellipsis;'");
