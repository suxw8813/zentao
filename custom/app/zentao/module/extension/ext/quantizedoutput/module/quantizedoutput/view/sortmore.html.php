        ...
        <form method='post'>
         ...
         <table class='table table-condensed table-striped table-bordered tablesorter table-fixed active-disabled' id='daywork'>
            ...
            <tr class='colhead'>
              ...
              <th><?php echo $lang->quantizedoutput->amiba_name;?></th>
              <th><?php echo $lang->quantizedoutput->group_name;?></th>
              ...
              <th style='color:red;' width='100'><?php echo $lang->quantizedoutput->day_avg_time . '(' . $workDayCount . '天)';?></th>
              <th style='color:red;' data-container='body' data-toggle='popover' data-placement='top' data-trigger='hover' data-content='<?php 
                ...
                ?>'>
              <?php echo $lang->quantizedoutput->extra_time;?>
              </th>
              <?php else:?>
              <th><?php echo $lang->quantizedoutput->quantizedoutputed . $lang->quantizedoutput->tasktime;?></th>
              <th width='100'><?php echo $lang->quantizedoutput->day_avg_time . '(' . $workDayCount . '天)';?></th>
              ...
              <th style='color:red;'><?php echo $lang->quantizedoutput->day_avg . $lang->quantizedoutput->output;?></th>
              <?php else:?>
              <th><?php echo $lang->quantizedoutput->real . $lang->quantizedoutput->output;?></th>
              <th><?php echo $lang->quantizedoutput->day_avg . $lang->quantizedoutput->output;?></th>
              <?php endif;?>
            ...
            <?php foreach($monthWorkSortData as $user):?>
              <tr class="a-center">
                ...
                if($user->total_time > 0) {
                    if($timeType == $lang->quantizedoutput->month) {
                        $timetendencyLink = $this->createLink('quantizedoutput', 'timetendency', "userRootId=$userRootId&amibaName=amiba&isAmibaChanged=false&groupName=groupName&account=$user->account&orgType=person&timeType=月&endNum=$dateNum&beginNum=");
                ...
                if($user->total_output > 0) {
                    if($timeType == $lang->quantizedoutput->month) {
                        $monthPerformanceLink = $this->createLink('quantizedoutput', 'monthperformance', "userRootId=$userRootId&amibaName=amiba&isAmibaChanged=false&groupName=groupName&account=$user->account&orgType=person&monthNum=$dateNum");
