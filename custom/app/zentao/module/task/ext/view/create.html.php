...
<?php/**feature-1488**/?>	  
      <tr id='contractsum' class='hidden'>
       <th class='w-100px'><?php echo $lang->task->contractsum;?></th>
       <td><?php echo html::input('contractsum', '0', "class=form-control id='contractsumvalue'  onkeyup='checkSum(this.value,0,10000)' ");?> </td><td><?php echo $lang->task->currencyunit ;?></td>
      </tr>	  
<?php/**------------**/?>	 	  
      <tr>
      ...
      <tr>
<?php/**feature-899-wx**/?>	  
        <th><?php echo $lang->task->desc.$lang->task->createnote;?></th>
