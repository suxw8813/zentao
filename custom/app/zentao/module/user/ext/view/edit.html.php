...
<div class='container mw-800px'>
  ...
  <form class='form-condensed' method='post' target='hiddenwin' id='dataform'>
    <table align='center' class='table table-form'>
	  ...
	  <tr>
		<th><?php echo $lang->company->province;?></th>
		<td><?php echo html::select('province', $lang->company->provinceList, $user->province, "class='form-control chosen'");?></td>
		<th></th>
		<td></td>
	  </tr>
    </table>
    ...
    <table align='center' class='table table-form'>
      ...
      <tr>
        ...
        <th><?php echo '是否显示报工';?></th>
        <td><?php echo html::radio('showreportwork', (array)$lang->user->showReportWork, $user->showreportwork);?></td>
      </tr>
      <tr>
        <th><?php echo '离职日期';?></th>
        <td><?php echo html::input('dimission', $user->dimission, "class='form-control form-date'");?></td>
      </tr>
