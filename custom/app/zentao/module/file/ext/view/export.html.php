    ...
    <tr>
      <td>
        <div class='input-group'>
          ...
          <?php echo html::input('fileName', $fileName, "class='form-control' autocomplete='off'");?>
        </div>
      </td>
      <td class='w-60px'>
        <?php echo html::select('fileType',   $lang->exportFileTypeList, $exportFileType, 'onchange=switchEncode(this.value) class="form-control"');?>
      </td>
      <td class='w-80px'>
        <?php echo html::select('encode',     $config->charsets[$this->cookie->lang], $charset, key($lang->exportFileTypeList) == 'csv' ? "class='form-control'" : "class='form-control'");?>
      </td>
      <td class='w-90px'>
        <?php echo html::select('exportType', $lang->exportTypeList, $exportType, "class='form-control'");?>
      </td>
