...
function changeParams(obj)
{
    ...
    link = createLink('report', 'timetendency', 'userRootId=' + userRootId + '&amibaName=' + amibaName +'&isAmibaChanged=' + isAmibaChanged + '&groupName=' + groupName +'&account=' + account +'&orgType=' + orgType +'&timeType=' + timeType + '&endNum=' + endNum + '&beginNum=' + beginNum);
    // alert(link);
    location.href=link;
};