...
<div class='main' id='sort'>
    ...
    <div class='container text-center bd-0'>
      <h1 style="margin-top: 0px;" data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('report', 'sortmore', "timeType=$timeType&sortField=total_output&userRootId=$userRootId&amibaName=&groupName=&userName=&timeNum=$timeNum");
        print(html::a($worklogsLink, $lang->report->more, '', 'class="iframe btn btn-primary btn-sm" data-width="65%"'));
        ?>
      </h1>
    ...
    <div class='container text-center bd-0'>
      <h1 data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('report', 'sortmore', "timeType=$timeType&sortField=output_efficiency&userRootId=$userRootId&amibaName=&groupName=&userName=&timeNum=$timeNum");
        print(html::a($worklogsLink, $lang->report->more, '', 'class="iframe btn btn-primary btn-sm" data-width="65%"'));
        ?>
      </h1>
    ...
    <div class='container text-center bd-0'>
      <h1 data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        ...
        <?php 
        $worklogsLink = $this->createLink('report', 'sortmore', "timeType=$timeType&sortField=total_time&userRootId=$userRootId&amibaName=&groupName=&userName=&timeNum=$timeNum");
        print(html::a($worklogsLink, $lang->report->more, '', 'class="iframe btn btn-primary btn-sm" data-width="65%"'));
        ?>
      </h1>
    ...
    <div class='container text-center bd-0'>
      <h1 data-container='body' data-toggle='popover' data-placement='bottom' data-trigger='hover' data-content='<?php echo $statPeriod;?>'>
        <?php echo '阿米巴人均-' . $timeType . '报工工时-排名' . '（' . $timeStr . '）';?>
      </h1>
