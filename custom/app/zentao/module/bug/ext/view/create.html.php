  ...
  <form class='form-condensed' method='post' enctype='multipart/form-data' id='dataform' data-type='ajax'>
    <table class='table table-form'> 
      ...
      <tr>
		...
		<td>
		  <div class='input-group' id='sourceType'>
		    <span class='input-group-addon'><?php echo $lang->bug->sourceTP?></span>
		    <span><?php echo html::select('sourceTP', $lang->bug->sourceTPList, $sourceTP, "class='form-control'"); ?></span>
		  </div>
		</td>
      </tr>
