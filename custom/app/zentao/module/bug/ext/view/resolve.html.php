...
<?php /*start:feature-1053*/?>
  <tr>
  	<tr id='confirmedNoteBox' class='hide'>
		<th></th>
		<td bgcolor="red"><?php echo $lang->bug->confirmednote;?></td>
	</tr>	
...
<?php /*start:feature-1053*/?>  
	  <td class='w-p35-f'><?php echo html::select('resolution', $lang->bug->resolutionList, '', 'class=form-control onchange=setDuplicate(this.value,'.$bug->confirmed.')');?></td><td></td>	  
<?php /*end:feature-1053*/?>	  
    </tr>
...
<?php /* id is added for feature-1053 */?>		
    <tr id='submitbuttonBox'>
