...
/***start:feature-1053*****/
		common::printIcon('bug', 'reconfirmBug', $params);
/***end:feature-1053*****/		
        echo '</div>';
...
<?php /***start:feature-851***/?>	
	  <fieldset>
		<legend><?php echo $lang->worklog->worklogbrowse;?></legend>
		<table class='table table-data table-condensed table-borderless'> 
			<tr class='text-center'>
				<th><?php echo $lang->worklog->realname;?></th>
				<th><?php echo $lang->worklog->workdate;?></th>
				<th><?php echo $lang->worklog->workcontent;?></th>
				<th><?php echo $lang->worklog->worktime;?></th>
				<th><?php echo $lang->worklog->workovertime;?></th>
			</tr>		
		   <?php foreach($worklogs as $worklog):?>
			  <tr>
				<td><?php echo $worklog->realname;?></td>
				<td><?php echo $worklog->workdate;?></td>
				<td><?php echo $worklog->workcontent;?></td>
        ...
        <div class='tab-content'>
          <div class='tab-pane active' id='legendBasicInfo'>
            <table class='table table-data table-condensed table-borderless table-fixed'>
              ...
              <tr>
	        <th><?php echo $lang->bug->sourceTP;?></th>
                <td><?php if(isset($lang->bug->sourceTPList[$bug->sourceTP])) echo $lang->bug->sourceTPList[$bug->sourceTP]; else echo $bug->sourceTP;?></td>
              </tr>
              <tr>
...
<?php /***start:feature-1053***/?>			  
              <tr>
                <th><?php echo $lang->bug->source;?></th>
                <td><?php echo $lang->bug->sourceList[$bug->source];?></td>
              </tr>		
              <tr>
                <th><?php echo $lang->bug->backtracking;?></th>
                <td><?php echo "-----------------------";?></td>
              </tr>	
              <tr>
                <th><?php echo $lang->bug->issimple;?></th>
                <td><?php echo $lang->bug->issimpleList[$bug->issimple];?></td>
              </tr>				  
			  
              <tr>
                <th><?php echo $lang->bug->rdresponser;?></th>
                <td><?php if($bug->rdresponser) echo $users[$bug->rdresponser];?></td>
              </tr>			
              <tr>
                <th><?php echo $lang->bug->testresponser;?></th>
                <td><?php if($bug->testresponser) echo $users[$bug->testresponser];?></td>
              </tr>				  
			  
              <tr>
                <th><?php echo $lang->bug->reqresponser;?></th>
                <td><?php if($bug->reqresponser) echo $users[$bug->reqresponser];?></td>
              </tr>					  
<?php /***end:feature-1053*****/?>				  
              <tr>
